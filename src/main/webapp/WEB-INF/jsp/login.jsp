...
<div class="container">
    <div class="lead">
        &nbsp;&nbsp;&nbsp;Java Enterprise project with
        registration/authorization and UI with roles (USER, ADMIN).

        Administrator can create/edit/delete users and user can manage his profile.
        Application helps users watch for their used calories per day through UI(with AJAX)
        and REST controllers with authorization. Also, it could filter data by date and time and
        color of row become red if amount of calories above limit in users profile.

        Application includes JUnit test coverage with Spring MVC Test and Spring Security Test.
    </div>
</div>
